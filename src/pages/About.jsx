        ...
        <>
            <Container>
                ...
                <SubHeadline>
                    ...
                    After various job experiences, such as photography,
                    translation and interpretation, I decided to try coding and
                    fell in love with it.
                </SubHeadline>
                <SubHeadline>
                    My journey started in November 2022. Since then, with
                    determination and ambition, I have been working hard to
                    become a developer. I love all sorts of knowledge and always
            ...
            <Container>
                ...
                <Description>
                    I have some experience working with Redux, Context API,
                    Axios, Zustand, Framer Motion etc.
                </Description>
            </Container>
        </>
    );
